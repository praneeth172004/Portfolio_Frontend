...
function About() {
  return (
    <div className="w-full h-screen bg-gray-900 flex flex-col justify-center items-center px-4 py-10 text-white">
      ...
      >
        I'm a passionate full-stack developer currently pursuing B.Tech in Computer Science. My primary tech stack includes
        <span className="text-white font-medium"> Java</span> for backend and the
